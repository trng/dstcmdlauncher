...
for /f "delims=" %%A in ('fsutil behavior query disable8dot3 ^| find /C ": 1"') do (
    if "%%A"=="1" (
        echo.
        echo %ESC%[93mВНИМАНИЕ^!%ESC%[0m
        echo %ESC%[93m    Короткие имена ^(8.3^) отключены на всех дисках.%ESC%[0m
...
if exist "%ServerConfigFile%" (
    ...
    echo.::::          ^(используется дефолтное имя: DSTcmdLauncher.conf^)     %ESC%[80G ::::
    echo.::::                                                                            ::::
...
echo.::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
echo.::
echo.::  Пробуем загрузить параметры...
echo.::
echo.::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
echo. & echo.
...
echo. & echo. & echo. & echo Нажмите любую клавишу если вы хоитите оставить это консольное окно открытым
call :timeout_with_keypress_detect 15
...
(echo ^
#%CRLF%^
# Конфигурационный файл для запуска скрипта DSTcmdLauncherXXX.cmd%CRLF%^
#%CRLF%%CRLF%%CRLF%^
#%CRLF%^
# FIRST RUN%CRLF%^
#%CRLF%^
